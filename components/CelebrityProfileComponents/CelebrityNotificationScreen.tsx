...
const CelebrityNotificationScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <ToggleItem
        ...
        isEnabled={isServiceOn}
        toggleSwitch={() => setIsServiceOn(!isServiceOn)}
        isLastItem // Pass a flag for the last item
      />
    </View>
  );
};

export default CelebrityNotificationScreen;
