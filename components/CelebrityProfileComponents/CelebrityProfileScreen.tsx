...
const CelebrityProfileSettings: React.FC = () => {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.profileSection}>
          ...
          <View>
            <Text style={styles.name}>Rough Daddii</Text>
            <Text style={styles.email}>roughdaddii@yourdomain.com</Text>
...
export default CelebrityProfileSettings;
