  ...
  return (
    <View style={styles.userItem}>
      ...
      <TouchableOpacity
        ...
        onPress={() => router.push("/(page)/usersProfile")}
      >
...
const CelebrityAllUsersScreen: React.FC = () => {
      ...
      <View style={styles.filterContainer}>
        ...
        >
          <FontAwesome5
            name="male"
            size={20}
            color={filter === "male" ? "#FFFFFF" : "#3f9217"}
          />
        </TouchableOpacity>
        <TouchableOpacity
          style={[
        ...
        >
          <FontAwesome5
            name="female"
            size={20}
            color={filter === "female" ? "#FFFFFF" : "#3f9217"}
          />
        </TouchableOpacity>
      </View>
...
export default CelebrityAllUsersScreen;
